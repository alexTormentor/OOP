...
{
    enum Components                                                                                                 // компоненты меха
    {
        ArmoreMk, WeaponMk, EngineMk, SystemVer
    }
    class MachineFactory                                                                                            // класс с командами
    {
        public decimal Armore { get; private set; }                                                                 // поля для изменения
        public decimal Weapon { get; private set; }
        public decimal Engine { get; private set; }
        public decimal MechSystem { get; private set; }
        public void MechArmoreDeploy(Components components, decimal component) => Armore = components switch        // изменяем поля 
        {
